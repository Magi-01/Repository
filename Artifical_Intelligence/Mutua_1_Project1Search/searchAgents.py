...
class CornersProblem(search.SearchProblem):
    ...
    def getStartState(self):
        """
        Returns the start state (position, empty visited corners).
        """
    ...
    def isGoalState(self, state):
        ...
        return set(visited_corners) == set(self.corners)
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not self.walls[next_x][next_y]:
                ...
                if next_position in self.corners and next_position not in visited_corners:
                    new_visited_corners = visited_corners + (next_position,)
...
def cornersHeuristic(state, problem):
    ...
    while unvisited_corners:
        ...
        distances = [
            (abs(position[0]-corner[0])+abs(position[1]-corner[1]), corner)
...
def foodHeuristic(state, problem):
    ...
    # Sets the heuristic such that the shotest path is to the closest food (kind of cheating as setting heuristic equal to true distance)
